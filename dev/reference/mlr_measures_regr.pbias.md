...
The Percent Bias is defined as \$\$ \frac{1}{n} \sum\_{i=1}^n w_i
\frac{\left( r_i - t_i \right)}{\left\| t_i \right\|}, \$\$ where
\\w_i\\ are normalized sample weights. Good predictions score close to
0.

## Note

The score function calls
[`mlr3measures::pbias()`](https://mlr3measures.mlr-org.com/reference/pbias.html)
from package
