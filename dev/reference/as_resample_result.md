...
objects and all other relevant objects
([Task](https://mlr3.mlr-org.com/dev/reference/Task.md),
[Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md)s, and
instantiated
[Resampling](https://mlr3.mlr-org.com/dev/reference/Resampling.md)) must
be provided, too. A more flexible way to manually create a
[ResampleResult](https://mlr3.mlr-org.com/dev/reference/ResampleResult.md)
is implemented in
