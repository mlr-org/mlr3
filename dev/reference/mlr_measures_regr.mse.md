...
The Mean Squared Error is defined as \$\$ \frac{1}{n} \sum\_{i=1}^n w_i
\left( t_i - r_i \right)^2, \$\$ where \\w_i\\ are normalized sample
weights.

## Note

The score function calls
[`mlr3measures::mse()`](https://mlr3measures.mlr-org.com/reference/mse.html)
from package
