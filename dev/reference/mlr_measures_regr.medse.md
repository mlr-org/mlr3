...
The Median Squared Error is defined as \$\$ \mathop{\mathrm{median}}
\left\[ \left( t_i - r_i \right)^2 \right\]. \$\$

## Note

The score function calls
[`mlr3measures::medse()`](https://mlr3measures.mlr-org.com/reference/medse.html)
from package
