...
for [Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md). Note
that this function is intended as glue code to be used in third party
packages. We recommend to work with the
[Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md) directly,
i.e. calling `learner$predict()` or `learner$predict_newdata()`
directly.
...
- Creates a
  ...
  object by calling `learner$predict_newdata()`.
...
- object:
  ...
  Any [Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md).
...
- predict_type:
  ...
  complete
  [Prediction](https://mlr3.mlr-org.com/dev/reference/Prediction.md)
  object. If set to `NULL` (default), the first predict type for the
  respective class of the
  [Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md) as stored
  in
