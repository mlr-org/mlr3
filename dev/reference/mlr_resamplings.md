...
[Resampling](https://mlr3.mlr-org.com/dev/reference/Resampling.md). Each
...
strategies, see
[`rsmp()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)/[`rsmps()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md).
