...
- intask:
  ...
  A [Task](https://mlr3.mlr-org.com/dev/reference/Task.md) to be
  converted.
...
- new_type:
  ...
  [`mlr_reflections$task_types`](https://mlr3.mlr-org.com/dev/reference/mlr_reflections.md)\].
...
[Task](https://mlr3.mlr-org.com/dev/reference/Task.md) of requested
type.
