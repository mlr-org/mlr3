...
- [`LearnerClassifFeatureless$new()`](#method-LearnerClassifFeatureless-initialize)
...
- [`LearnerClassif$predict_newdata_fast()`](https://mlr3.mlr-org.com/dev/reference/LearnerClassif.html#method-predict_newdata_fast)
