...
- Creates
  [Prediction](https://mlr3.mlr-org.com/dev/reference/Prediction.md)s of
  class
...
- [`LearnerRegr$new()`](#method-LearnerRegr-initialize)
...
- [`Learner$selected_features()`](https://mlr3.mlr-org.com/dev/reference/Learner.html#method-selected_features)
...
- `properties`:
  ...
  [Learner](https://mlr3.mlr-org.com/dev/reference/Learner.md). Must be
  a subset of
...
you must pass the associated task object stored in the corresponding
