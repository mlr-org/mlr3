...
\frac{\mathrm{TP}}{\mathrm{TP} + \mathrm{FN}}. \$\$ This is also know as
"recall", "sensitivity", or "probability of detection".
...
[`mlr3measures::sensitivity()`](https://mlr3measures.mlr-org.com/reference/tpr.html)
from package
