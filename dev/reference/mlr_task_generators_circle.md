...
#>  $ y : Factor w/ 2 levels "A","B": 1 2 2 1 1 2 1 2 1 1 ...
#>  $ x1: num  0.0563 0.7881 -0.0145 0.6641 0.1689 ...
#>  $ x2: num  -0.319 -0.851 -0.843 0.131 0.705 ...
#>  - attr(*, ".internal.selfref")=<pointer: 0x55955f5f4ee0> 
```
