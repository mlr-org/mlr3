...
This measure counts the false positives (type 1 error), i.e. the number
of predictions indicating a positive class label while in fact it is
negative. This is sometimes also called a "false alarm".

## Note

The score function calls
[`mlr3measures::fp()`](https://mlr3measures.mlr-org.com/reference/fp.html)
from package
