...
- [`Task`](https://mlr3.mlr-org.com/dev/reference/Task.md) : Task Class
...
- [`california_housing`](https://mlr3.mlr-org.com/dev/reference/california_housing.md)
  [`mlr_tasks_california_housing`](https://mlr3.mlr-org.com/dev/reference/california_housing.md)
...
- [`as_task()`](https://mlr3.mlr-org.com/dev/reference/as_task.md)
  [`as_tasks()`](https://mlr3.mlr-org.com/dev/reference/as_task.md) :
  Convert to a Task
...
- [`mlr_task_generators_2dnormals`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_2dnormals.md)
  [`TaskGenerator2DNormals`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_2dnormals.md)
...
- [`mlr_task_generators_cassini`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_cassini.md)
  [`TaskGeneratorCassini`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_cassini.md)
...
- [`mlr_task_generators_circle`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_circle.md)
  [`TaskGeneratorCircle`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_circle.md)
...
- [`mlr_task_generators_friedman1`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_friedman1.md)
  [`TaskGeneratorFriedman1`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_friedman1.md)
...
- [`mlr_task_generators_moons`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_moons.md)
  [`TaskGeneratorMoons`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_moons.md)
...
- [`mlr_task_generators_peak`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_peak.md)
  [`TaskGeneratorPeak`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_peak.md)
...
- [`mlr_task_generators_simplex`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_simplex.md)
  [`TaskGeneratorSimplex`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_simplex.md)
...
- [`mlr_task_generators_smiley`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_smiley.md)
  [`TaskGeneratorSmiley`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_smiley.md)
...
- [`mlr_task_generators_spirals`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_spirals.md)
  [`TaskGeneratorSpirals`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_spirals.md)
...
- [`mlr_task_generators_xor`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_xor.md)
  [`TaskGeneratorXor`](https://mlr3.mlr-org.com/dev/reference/mlr_task_generators_xor.md)
...
- [`mlr_learners_classif.featureless`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_classif.featureless.md)
  [`LearnerClassifFeatureless`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_classif.featureless.md)
...
- [`mlr_learners_classif.rpart`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_classif.rpart.md)
  [`LearnerClassifRpart`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_classif.rpart.md)
  : Classification Tree Learner
- [`mlr_learners_regr.debug`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_regr.debug.md)
  [`LearnerRegrDebug`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_regr.debug.md)
...
- [`mlr_learners_regr.featureless`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_regr.featureless.md)
  [`LearnerRegrFeatureless`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_regr.featureless.md)
  : Featureless Regression Learner
- [`mlr_learners_regr.rpart`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_regr.rpart.md)
  [`LearnerRegrRpart`](https://mlr3.mlr-org.com/dev/reference/mlr_learners_regr.rpart.md)
  : Regression Tree Learner
- [`as_learner()`](https://mlr3.mlr-org.com/dev/reference/as_learner.md)
  [`as_learners()`](https://mlr3.mlr-org.com/dev/reference/as_learner.md)
...
- [`mlr_measures_aic`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_aic.md)
  [`MeasureAIC`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_aic.md)
...
- [`mlr_measures_best_valid_score`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_best_valid_score.md)
  [`MeasureBestValidScore`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_best_valid_score.md)
  : Measure Best Validation Score
- [`mlr_measures_bic`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_bic.md)
  [`MeasureBIC`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_bic.md)
...
- [`mlr_measures_debug_classif`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_debug_classif.md)
  [`MeasureDebugClassif`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_debug_classif.md)
...
- [`mlr_measures_elapsed_time`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_elapsed_time.md)
  [`MeasureElapsedTime`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_elapsed_time.md)
  [`mlr_measures_time_train`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_elapsed_time.md)
  [`mlr_measures_time_predict`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_elapsed_time.md)
  [`mlr_measures_time_both`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_elapsed_time.md)
...
- [`mlr_measures_internal_valid_score`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_internal_valid_score.md)
  [`MeasureInternalValidScore`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_internal_valid_score.md)
  : Measure Internal Validation Score
- [`mlr_measures_oob_error`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_oob_error.md)
  [`MeasureOOBError`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_oob_error.md)
...
- [`mlr_measures_regr.pinball`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_regr.pinball.md)
  [`MeasureRegrPinball`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_regr.pinball.md)
...
- [`mlr_measures_regr.rqr`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_regr.rqr.md)
  [`MeasureRegrRQR`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_regr.rqr.md)
  : R-Squared for Quantile Regression
- [`mlr_measures_regr.rsq`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_regr.rsq.md)
  [`MeasureRegrRSQ`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_regr.rsq.md)
  : R-Squared
...
- [`mlr_measures_selected_features`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_selected_features.md)
  [`MeasureSelectedFeatures`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_selected_features.md)
  : Selected Features Measure
- [`mlr_measures_sim.jaccard`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_sim.jaccard.md)
  : Jaccard Similarity Index
- [`mlr_measures_sim.phi`](https://mlr3.mlr-org.com/dev/reference/mlr_measures_sim.phi.md)
...
- [`as_measure()`](https://mlr3.mlr-org.com/dev/reference/as_measure.md)
...
- [`print(`*`<roc_measures>`*`)`](https://mlr3.mlr-org.com/dev/reference/print.roc_measures.md)
  : Print ROC Measures
...
- [`mlr_resamplings_custom`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_custom.md)
  [`ResamplingCustom`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_custom.md)
  : Custom Resampling
- [`mlr_resamplings_custom_cv`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_custom_cv.md)
  [`ResamplingCustomCV`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_custom_cv.md)
...
- [`mlr_resamplings_insample`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_insample.md)
  [`ResamplingInsample`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_insample.md)
  : Insample Resampling
- [`mlr_resamplings_loo`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_loo.md)
  [`ResamplingLOO`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_loo.md)
  : Leave-One-Out Cross-Validation
- [`mlr_resamplings_repeated_cv`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_repeated_cv.md)
  [`ResamplingRepeatedCV`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_repeated_cv.md)
...
- [`mlr_resamplings_subsampling`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_subsampling.md)
  [`ResamplingSubsampling`](https://mlr3.mlr-org.com/dev/reference/mlr_resamplings_subsampling.md)
  : Subsampling Resampling
- [`as_resampling()`](https://mlr3.mlr-org.com/dev/reference/as_resampling.md)
  [`as_resamplings()`](https://mlr3.mlr-org.com/dev/reference/as_resampling.md)
...
- [`uhashes()`](https://mlr3.mlr-org.com/dev/reference/uhash.md)
  [`uhash()`](https://mlr3.mlr-org.com/dev/reference/uhash.md) : Obtain
...
- [`as_measure()`](https://mlr3.mlr-org.com/dev/reference/as_measure.md)
  [`as_measures()`](https://mlr3.mlr-org.com/dev/reference/as_measure.md)
  : Convert to a Measure
- [`as_prediction()`](https://mlr3.mlr-org.com/dev/reference/as_prediction.md)
  [`as_predictions()`](https://mlr3.mlr-org.com/dev/reference/as_prediction.md)
...
- [`as_prediction_data()`](https://mlr3.mlr-org.com/dev/reference/as_prediction_data.md)
  : PredictionData
...
- [`install_pkgs()`](https://mlr3.mlr-org.com/dev/reference/install_pkgs.md)
  [`extract_pkgs()`](https://mlr3.mlr-org.com/dev/reference/install_pkgs.md)
...
- [`tsk()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)
  ...
  [`tgens()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)
  ...
  [`rsmps()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)
  [`msr()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)
  [`msrs()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)
  [`set_validate()`](https://mlr3.mlr-org.com/dev/reference/mlr_sugar.md)
  : Syntactic Sugar for Object Construction
- [`mlr_reflections`](https://mlr3.mlr-org.com/dev/reference/mlr_reflections.md)
...
- [`assert_resample_callback()`](https://mlr3.mlr-org.com/dev/reference/assert_resample_callback.md)
  [`assert_resample_callbacks()`](https://mlr3.mlr-org.com/dev/reference/assert_resample_callback.md)
  : Assertions for Callbacks
- [`mlr3.model_extractor`](https://mlr3.mlr-org.com/dev/reference/mlr3.model_extractor.md)
  : Model Extractor Callback
- [`mlr3.holdout_task`](https://mlr3.mlr-org.com/dev/reference/mlr3.holdout_task.md)
  : Callback Holdout Task

## Internal Objects and Functions

- [`learner_unmarshal()`](https://mlr3.mlr-org.com/dev/reference/marshaling.md)
  [`learner_marshal()`](https://mlr3.mlr-org.com/dev/reference/marshaling.md)
  [`learner_marshaled()`](https://mlr3.mlr-org.com/dev/reference/marshaling.md)
  ...
  [`is_marshaled_model()`](https://mlr3.mlr-org.com/dev/reference/marshaling.md)
  : (Un)marshal a Learner
- [`MeasureSimilarity`](https://mlr3.mlr-org.com/dev/reference/MeasureSimilarity.md)
  : Similarity Measure
- [`assert_backend()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_task()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_tasks()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_learner()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_learners()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_learnable()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_predictable()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  ...
  [`assert_measures()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_resampling()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_resamplings()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_prediction()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_resample_result()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_benchmark_result()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_row_ids()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_has_backend()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_quantiles()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  [`assert_validate()`](https://mlr3.mlr-org.com/dev/reference/mlr_assertions.md)
  : Assertion for mlr3 Objects
- [`ResultData`](https://mlr3.mlr-org.com/dev/reference/ResultData.md) :
  ResultData
- [`create_empty_prediction_data()`](https://mlr3.mlr-org.com/dev/reference/PredictionData.md)
  [`check_prediction_data()`](https://mlr3.mlr-org.com/dev/reference/PredictionData.md)
  [`is_missing_prediction_data()`](https://mlr3.mlr-org.com/dev/reference/PredictionData.md)
  [`filter_prediction_data()`](https://mlr3.mlr-org.com/dev/reference/PredictionData.md)
  [`c(`*`<PredictionDataClassif>`*`)`](https://mlr3.mlr-org.com/dev/reference/PredictionData.md)
  [`c(`*`<PredictionDataRegr>`*`)`](https://mlr3.mlr-org.com/dev/reference/PredictionData.md)
...
- [`mlr_test_helpers`](https://mlr3.mlr-org.com/dev/reference/mlr_test_helpers.md)
  : Documentation of mlr3 test helpers

## Package

- [`mlr3`](https://mlr3.mlr-org.com/dev/reference/mlr3-package.md)
  [`mlr3-package`](https://mlr3.mlr-org.com/dev/reference/mlr3-package.md)
