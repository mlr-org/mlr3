...
The Sum of Squared Errors is defined as \$\$ \sum\_{i=1}^n w_i \left(
t_i - r_i \right)^2. \$\$ where \\w_i\\ are unnormalized weights for
each observation \\x_i\\, defaulting to 1.

## Note

The score function calls
[`mlr3measures::sse()`](https://mlr3measures.mlr-org.com/reference/sse.html)
from package
