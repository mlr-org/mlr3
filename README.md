...
* Be light on dependencies. `mlr3` only requires the following packages:
    ...
    - [`paradox`](https://cran.r-project.org/package=measures): Descriptions for parameters and parameter sets. Developed by members of the `mlr` team. No extra reverse dependencies. [TODO: Remove `BBmisc` dependency]
