...
#' The \CRANpkg{future} package guarantees reproducible results independent of the parallel backend.
#' The results of \CRANpkg{mirai} will not be the same but can be made reproducible by setting a `seed` and `dispatcher = FALSE` when calling `mirai::daemons()`.
