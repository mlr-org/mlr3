...
#'  Get (a subset of) the task data. Rows must be specified by row_ids (defaulting to integers if not specified otherwise), columns must be addressed by name.
...
#' @field col_types [\code{named character}]\cr
