...
#' Classification tasks default to the classification error in ["classif.ce"][mlr_measure_classif.ce], regression tasks to the mean squared error in ["regr.mse"][mlr_measure_regr.mse].
