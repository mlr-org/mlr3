...
experiment_train = function(self, private, row_ids, ctrl = list()) {
  ...
  lg$info("Training learner '%s' on task '%s' ...", self$learner$id, self$task$id, namespace = "mlr3")
...
experiment_predict = function(self, private, row_ids = NULL, newdata = NULL, ctrl = list()) {
  ...
  lg$info("Predicting with model of learner '%s' on task '%s' ...", self$learner$id, self$task$id, namespace = "mlr3")
...
experiment_score = function(self, private, ctrl = list()) {
  ...
  lg$info("Scoring predictions of learner '%s' on task '%s' ...", self$learner$id, self$task$id, namespace = "mlr3")
