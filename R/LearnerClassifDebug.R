  ...
  public = list(
    ...
    initialize = function() {
      super$initialize(
        ...
        param_set = ps(
          message_train = p_dbl(lower = 0, upper = 1, default = 0, tags = "train"),
          message_predict = p_dbl(lower = 0, upper = 1, default = 0, tags = "predict"),
          warning_train = p_dbl(lower = 0, upper = 1, default = 0, tags = "train"),
          warning_predict = p_dbl(lower = 0, upper = 1, default = 0, tags = "predict"),
          error_train = p_dbl(lower = 0, upper = 1, default = 0, tags = "train"),
          error_predict = p_dbl(lower = 0, upper = 1, default = 0, tags = "predict"),
          segfault_train = p_dbl(lower = 0, upper = 1, default = 0, tags = "train"),
          segfault_predict = p_dbl(lower = 0, upper = 1, default = 0, tags = "predict"),
          predict_missing = p_dbl(lower = 0, upper = 1, default = 0, tags = "predict"),
          save_tasks = p_lgl(default = FALSE, tags = c("train", "predict")),
          threads = p_int(lower = 1, tags = c("train", "threads")),
