...
#'
#' @details
#' When implementing inner tuning for a [`Learner`], a method for this function should be provided.
...
#' Note that this function should not change the value of the `$validate` parameter.
#'
...
#' @return Modified input [`Learner`]
#' @export
#' @examples
#' learner = lrn("classif.debug", validate = 0.3, early_stopping = TRUE, iter = 100)
#' disable_inner_tunign(learner)
#' learner
disable_inner_tuning = function(learner, ids = NULL, ...) {
