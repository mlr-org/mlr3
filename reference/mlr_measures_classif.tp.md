...
This measure counts the true positives, i.e. the number of predictions
correctly indicating a positive class label. This is sometimes also
called a "hit".

## Note

The score function calls
[`mlr3measures::tp()`](https://mlr3measures.mlr-org.com/reference/tp.html)
from package
