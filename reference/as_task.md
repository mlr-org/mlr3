...
Convert object to a [Task](https://mlr3.mlr-org.com/reference/Task.md)
or a list of [Task](https://mlr3.mlr-org.com/reference/Task.md).

The function supports:

- Converting existing [Task](https://mlr3.mlr-org.com/reference/Task.md)
  objects (with optional cloning)
