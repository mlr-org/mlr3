...
[`benchmark()`](https://mlr3.mlr-org.com/reference/benchmark.md)), using
a set of hyperparameters such as the number of folds in
cross-validation.

Resampling objects can be instantiated on a
[Task](https://mlr3.mlr-org.com/reference/Task.md), which applies the
strategy on the task and manifests in a fixed partition of `row_ids` of
the [Task](https://mlr3.mlr-org.com/reference/Task.md).

Predefined resamplings are stored in the
[dictionary](https://mlr3misc.mlr-org.com/reference/Dictionary.html)
[mlr_resamplings](https://mlr3.mlr-org.com/reference/mlr_resamplings.md),
e.g. [`cv`](https://mlr3.mlr-org.com/reference/mlr_resamplings_cv.md) or
[`bootstrap`](https://mlr3.mlr-org.com/reference/mlr_resamplings_bootstrap.md).
...
[Task](https://mlr3.mlr-org.com/reference/Task.md) with column role
...
- `instance`:
  ...
  [Task](https://mlr3.mlr-org.com/reference/Task.md), a Resampling may
  operate on the group ids internally instead of the row ids (which may
  lead to confusion).
...
- `task_hash`:
  ...
  (`character(1)`)  
  The hash of the [Task](https://mlr3.mlr-org.com/reference/Task.md)
...
- `task_row_hash`:
  ...
  [Task](https://mlr3.mlr-org.com/reference/Task.md) which was passed to
  `r$instantiate()`.
