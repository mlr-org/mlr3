...
- `weights`:
  ...
  of the [Task](https://mlr3.mlr-org.com/reference/Task.md) if present.
...
[Learner](https://mlr3.mlr-org.com/reference/Learner.md) may be `NULL`
for most measures, but some measures need to extract information from
these objects. Note that the `predict_sets` of the `measures` are
