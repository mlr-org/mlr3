...
- `tsk()` for a [Task](https://mlr3.mlr-org.com/reference/Task.md) from
  [mlr_tasks](https://mlr3.mlr-org.com/reference/mlr_tasks.md).

- `tsks()` for a list of
  [Task](https://mlr3.mlr-org.com/reference/Task.md)s from
  [mlr_tasks](https://mlr3.mlr-org.com/reference/mlr_tasks.md).
...
- `tgens()` for a list of
  [TaskGenerator](https://mlr3.mlr-org.com/reference/TaskGenerator.md)s
  from
  [mlr_task_generators](https://mlr3.mlr-org.com/reference/mlr_task_generators.md).

- `lrn()` for a [Learner](https://mlr3.mlr-org.com/reference/Learner.md)
  from
  [mlr_learners](https://mlr3.mlr-org.com/reference/mlr_learners.md).

- `lrns()` for a list of
  [Learner](https://mlr3.mlr-org.com/reference/Learner.md)s from
  [mlr_learners](https://mlr3.mlr-org.com/reference/mlr_learners.md).

- `rsmp()` for a
  [Resampling](https://mlr3.mlr-org.com/reference/Resampling.md) from
  [mlr_resamplings](https://mlr3.mlr-org.com/reference/mlr_resamplings.md).

- `rsmps()` for a list of
  [Resampling](https://mlr3.mlr-org.com/reference/Resampling.md)s from
  [mlr_resamplings](https://mlr3.mlr-org.com/reference/mlr_resamplings.md).

- `msr()` for a [Measure](https://mlr3.mlr-org.com/reference/Measure.md)
  from
  [mlr_measures](https://mlr3.mlr-org.com/reference/mlr_measures.md).

- `msrs()` for a list of
  [Measure](https://mlr3.mlr-org.com/reference/Measure.md)s from
  [mlr_measures](https://mlr3.mlr-org.com/reference/mlr_measures.md).
...
Modified [`Learner`](https://mlr3.mlr-org.com/reference/Learner.md)
