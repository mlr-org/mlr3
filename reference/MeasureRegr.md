...
[Measure](https://mlr3.mlr-org.com/reference/Measure.md) for regression
problems:

- `task_type` is set to `"regr"`.

- Possible values for `predict_type` are `"response"`, `"se"` and
  `"distr"`.

Predefined measures can be found in the
[dictionary](https://mlr3misc.mlr-org.com/reference/Dictionary.html)
[mlr_measures](https://mlr3.mlr-org.com/reference/mlr_measures.md). The
default measure for regression is
[`regr.mse`](https://mlr3.mlr-org.com/reference/mlr_measures_regr.mse.md).
...
- [`MeasureRegr$new()`](#method-MeasureRegr-initialize)

- [`MeasureRegr$clone()`](#method-MeasureRegr-clone)
