...
[Learner](https://mlr3.mlr-org.com/reference/Learner.md). This is only
available for learners that have both the `"validation"` and the
...
While
[`msr("internal_valid_score")`](https://mlr3.mlr-org.com/reference/mlr_measures_internal_valid_score.md)
