...
[Learner](https://mlr3.mlr-org.com/reference/Learner.md). Each learner
has an associated help page, see `mlr_learners_[id]`.
...
[`lrn()`](https://mlr3.mlr-org.com/reference/mlr_sugar.md)/[`lrns()`](https://mlr3.mlr-org.com/reference/mlr_sugar.md).
