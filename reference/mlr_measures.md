...
[Measure](https://mlr3.mlr-org.com/reference/Measure.md). Each measure
has an associated help page, see `mlr_measures_[id]`.
...
[`msr()`](https://mlr3.mlr-org.com/reference/mlr_sugar.md)/[`msrs()`](https://mlr3.mlr-org.com/reference/mlr_sugar.md).
