...
- `task_types`
  ...
  and fallback [Learner](https://mlr3.mlr-org.com/reference/Learner.md).
  The column `"type"` must be unique for each row.

- `task_feature_types` (named
  [`character()`](https://rdrr.io/r/base/character.html))  
  Vector of base R types supported as
  [Task](https://mlr3.mlr-org.com/reference/Task.md) features, named
...
- `task_col_roles` (list of
  ...
  [Task](https://mlr3.mlr-org.com/reference/Task.md), named by their
  task type.

- `task_properties` (list of
  [`character()`](https://rdrr.io/r/base/character.html))  
  List of vectors of supported
  [Task](https://mlr3.mlr-org.com/reference/Task.md) properties, named
  by their task type.

- `task_mandatory_properties` (list of
  [`character()`](https://rdrr.io/r/base/character.html))  
  List of vectors of [Task](https://mlr3.mlr-org.com/reference/Task.md)
  properties which necessarily must be supported by the
  [Learner](https://mlr3.mlr-org.com/reference/Learner.md). I.e., if the
  task property is not found in the set of the learner properties, an
  exception is raised.
...
- `learner_properties` (list of
  [`character()`](https://rdrr.io/r/base/character.html))  
  List of vectors of supported
  [Learner](https://mlr3.mlr-org.com/reference/Learner.md) properties,
...
- `learner_param_tags`
  ...
  of a [Learner](https://mlr3.mlr-org.com/reference/Learner.md).
...
- `measure_properties` (list of
  [`character()`](https://rdrr.io/r/base/character.html))  
  List of vectors of supported
  [Measure](https://mlr3.mlr-org.com/reference/Measure.md) properties,
  named by their task type.

- `default_measures` (list of
  [`character()`](https://rdrr.io/r/base/character.html))  
  List of keys for the default
  [Measure](https://mlr3.mlr-org.com/reference/Measure.md)s, named by
  their task type.
...
#> auto_converters : <environment: 0x558f54c206a8> 
