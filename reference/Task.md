...
[TaskRegr](https://mlr3.mlr-org.com/reference/TaskRegr.md) inherit from
[TaskSupervised](https://mlr3.mlr-org.com/reference/TaskSupervised.md).
...
1.  Tasks wrap a
    [DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md), an
    object to transparently interface different data storage types.
...
[mlr_tasks](https://mlr3.mlr-org.com/reference/mlr_tasks.md), e.g.
[`penguins`](https://mlr3.mlr-org.com/reference/mlr_tasks_penguins.md)
or
...
- [Dictionary](https://mlr3misc.mlr-org.com/reference/Dictionary.html)
  of Tasks: [mlr_tasks](https://mlr3.mlr-org.com/reference/mlr_tasks.md)
...
- `internal_valid_task`:
  ...
  [`Learner`](https://mlr3.mlr-org.com/reference/Learner.md). If
...
- `col_hashes`:
  ...
  [`DataBackend`](https://mlr3.mlr-org.com/reference/DataBackend.md)s
...
e.g. [TaskClassif](https://mlr3.mlr-org.com/reference/TaskClassif.md) or
[TaskRegr](https://mlr3.mlr-org.com/reference/TaskRegr.md).
...
`data.table`. Rows default to observations with role `"use"`, and
...
available in the
[DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md). To
...
in `$backend`. New row ids are automatically created, unless `data` has
a column whose name matches the primary key of the
[DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md)
...
[DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md)). If
this column is missing, it is assumed that the rows are exactly in the
order of `$row_ids`. In case of name clashes of column names in `data`
and [DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md),
...
[DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md) for all
data required in the active view and replaces the internal
[DataBackend](https://mlr3.mlr-org.com/reference/DataBackend.md) with
the new one. In some scenarios this helps to free up memory or speeds up
accesses to the data, especially after several `$rbind()` and `$cbind()`
operations.
