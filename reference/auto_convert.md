...
`rbind`-ing of [Task](https://mlr3.mlr-org.com/reference/Task.md)s, but
also in some pipe operators in
[mlr3pipelines](https://CRAN.R-project.org/package=mlr3pipelines).

All rules are stored as functions in
[mlr_reflections\$auto_converters](https://mlr3.mlr-org.com/reference/mlr_reflections.md).
