...
[`benchmark()`](https://mlr3.mlr-org.com/reference/benchmark.md) via the
`ContextResample`. See the section on fields for a list of modifiable
objects. See
...
- `pdatas`:
  ...
  (List of
  [PredictionData](https://mlr3.mlr-org.com/reference/PredictionData.md))  
