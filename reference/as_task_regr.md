...
Convert object to a
[TaskRegr](https://mlr3.mlr-org.com/reference/TaskRegr.md). This is a S3
generic. mlr3 ships with methods for the following objects:

1.  [TaskRegr](https://mlr3.mlr-org.com/reference/TaskRegr.md): returns
    the object as-is, possibly cloned.
...
3.  [TaskClassif](https://mlr3.mlr-org.com/reference/TaskClassif.md):
    Calls
