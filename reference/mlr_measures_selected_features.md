...
[Task](https://mlr3.mlr-org.com/reference/Task.md) and the
[Learner](https://mlr3.mlr-org.com/reference/Learner.md) for scoring.
...
- [`MeasureSelectedFeatures$new()`](#method-MeasureSelectedFeatures-initialize)
