...
Note that method `$data()` is only an accesor and does not modify the underlying data/task.
To do this, please see methods [`$filter()`](basic-01-tasks.html#filter) and [`$select()`](basic-01-tasks.html#select).
