...
To overcome this issue, the resampling strategy needs to be instantiated before creating the design.
```{r}
...
resamplings[[1]]$instantiate(task[[1]])
...
Therefore, `mlr3` provides a helper function to quickly generate design tables and instantiate resampling strategies in an exhaustive grid fashion: `mlr3::cjoin()`.
...
tasks = map(tasks, function(task) { task$measures = measures; task })
