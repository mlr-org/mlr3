...
resampling = mlr.resamplings$get("subsampling")
...
```{r}
tasks = lapply(c("iris", "spam", "pima"), mlr.tasks$get)
learners = list(mlr.learners$get("classif.rpart"))
resamplings = list(mlr.resamplings$get("subsampling"))
...
plan("callr")
task = mlr.tasks$get("spam")
learner = mlr.learners$get("classif.crashtest")
