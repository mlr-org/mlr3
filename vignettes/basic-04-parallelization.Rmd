...
Make sure you have installed `future` and `future.apply` and load the respective namespaces:
```{r}
if (!requireNamespace("future.apply")) # future.apply depends on future
